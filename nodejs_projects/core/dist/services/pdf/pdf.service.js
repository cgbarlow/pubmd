...
const playwright_engine_js_1 = require("./playwright.engine.js"); // New engine
class PdfService {
    constructor(markdownService, pdfEngine) {
        this.markdownService = markdownService || new markdown_service_js_1.MarkdownService();
        this.pdfEngine = pdfEngine || new playwright_engine_js_1.PlaywrightPdfEngine(); // Default to Playwright engine
    }
